"""
pt 2 same idea but we will make an array of all starting levels of 1
"""
...
# we know the that the answer from pt1 was for me 339 and so we can just start with that as a min
min = 339

# iterate through all level 1 starting positions
